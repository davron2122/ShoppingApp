                ...
                if (!email.isEmpty() && !password.isEmpty()) {
                    ...
                    call.enqueue(new Callback<User>() {
                        ...
                        public void onResponse(Call<User> call, Response<User> response) {
                            ...
                            preferenceManager.setValue("password", user.getPassword());
...
//                binding.icVerifiedEmail.setVisibility(isEmailValid(email) ? View.VISIBLE : View.VISIBLE);
            }
        });
...
//                    binding.passwordEdittext.setTransformationMethod(PasswordTransformationMethod.getInstance());
                    binding.emailEditText.setInputType(InputType.TYPE_CLASS_TEXT | InputType.TYPE_CLASS_TEXT);
                }
